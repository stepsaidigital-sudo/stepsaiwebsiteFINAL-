# skills.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Explain reusable agent skills. Existing title: “Skills — StepsAI | What your agent actually knows how to do.”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [skills.html](../../../skills.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`, `channel-premium.css`, `channel-premium-bold.css`, `signature-skills.css`.
...
- 2 dark-marked sections; 1 legacy logo reference(s) at lines 722. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. What your agent actually knows how to do.

Source: `skills.html:503`; current classes: `vertical-hero`. Audit desktop height: 660px; padding: 72px 0px 90px.
...
Preserve destinations: `Start free trial → pricing.html`; `All agent features → agents.html`.

### 2. Six skills. Each one has its own job.

Source: `skills.html:551`; current classes: `section section--raised section--atmo`. Audit desktop height: 957px; padding: 120px 0px.
...
### 3. Skills aren't a menu. They're matched to what's actually asked.

Source: `skills.html:601`; current classes: `section section--dark`. Audit desktop height: 871px; padding: 120px 0px.
...
Source: `skills.html:642`; current classes: `section section--base section--atmo`. Audit desktop height: 631px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 5. Give your agent something to finish, not just answer.

Source: `skills.html:681`; current classes: `section section--dark final-cta`. Audit desktop height: 501px; padding: 120px 0px.
...
- `skills.html:508` — What your agent actually knows how to do.
- `skills.html:559` — Six skills. Each one has its own job.
- `skills.html:605` — Skills aren't a menu. They're matched to what's actually asked.
- `skills.html:650` — About skills.
- `skills.html:683` — Give your agent something to finish, not just answer.

## Mockup and responsive composition

Show a skill configuration and a matching executed action; distinguish available capabilities from future concepts.
...
- Proposed candidates: Editable configuration UI.
...
1. The mockup communicates “explain reusable agent skills” and the original content landmarks remain accessible.
