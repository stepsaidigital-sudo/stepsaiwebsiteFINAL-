# lead-agent.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Show useful lead capture and qualification. Existing title: “Lead Agent — StepsAI | Every enquiry, qualified before it reaches you.”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [lead-agent.html](../../../lead-agent.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`, `channel-premium.css`, `channel-premium-bold.css`, `signature-lead.css`.
...
### 1. Every enquiry, qualified before it reaches you.

Source: `lead-agent.html:491`; current classes: `vertical-hero`. Audit desktop height: 658px; padding: 72px 0px 90px.
...
### 2. A qualifying conversation, not a dead-end form.

Source: `lead-agent.html:533`; current classes: `section section--raised section--atmo`. Audit desktop height: 2477px; padding: 120px 0px.
...
Retain these content units: “Who they are, what they need, how soon.”; “Every lead arrives with the whole conversation.”; “High-intent leads reach a human fast.”; “"Anonymous Visitor" becomes a qualified lead, field by field.”.

### 3. Every lead lands exactly where your team already works.

Source: `lead-agent.html:658`; current classes: `section section--dark`. Audit desktop height: 509px; padding: 120px 0px.
...
### 4. Questions about the Lead Agent.

Source: `lead-agent.html:678`; current classes: `section section--base section--atmo`. Audit desktop height: 631px; padding: 120px 0px.
...
### 5. Stop losing enquiries to a form nobody fills out.

Source: `lead-agent.html:716`; current classes: `section section--dark final-cta`. Audit desktop height: 501px; padding: 120px 0px.
...
- `lead-agent.html:496` — Every enquiry, qualified before it reaches you.
- `lead-agent.html:541` — A qualifying conversation, not a dead-end form.
- `lead-agent.html:663` — Every lead lands exactly where your team already works.
- `lead-agent.html:686` — Questions about the Lead Agent.
- `lead-agent.html:718` — Stop losing enquiries to a form nobody fills out.

## Mockup and responsive composition

One enquiry becomes a contact record with source, intent, qualification answers and a clearly identified handoff.
...
- Proposed candidates: Existing lead-capture navigation illustration is secondary only.
...
1. The mockup communicates “show useful lead capture and qualification” and the original content landmarks remain accessible.
