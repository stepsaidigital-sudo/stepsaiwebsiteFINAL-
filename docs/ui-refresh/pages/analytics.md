# analytics.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Explain measurable performance. Existing title: “Analytics & Insights — StepsAI | See what it did, in plain English.”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [analytics.html](../../../analytics.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`, `analytics-deep.css`, `creative-showcase.css`, `channel-premium.css`, `channel-premium-bold.css`, `signature-analytics.css`.
- Scripts to preserve and exercise: `nav.js`, `breadcrumbs.js`, `industries.js`, `analytics-charts.js`, `channel-premium.js`.
...
- 1 dark-marked sections; 1 legacy logo reference(s) at lines 885. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. Know exactly what your agent is doing — and what it's worth.

Source: `analytics.html:493`; current classes: `vertical-hero`. Audit desktop height: 544px; padding: 72px 0px 90px.
...
### 2. Not a mockup. This is what you'll actually see.

Source: `analytics.html:509`; current classes: `section section--raised section--atmo`. Audit desktop height: 1812px; padding: 120px 0px.
...
Retain these content units: “Most of the day is quiet. Then it isn't.”.

### 3. Output, not just activity.

Source: `analytics.html:632`; current classes: `section section--base section--atmo`. Audit desktop height: 818px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 4. What one owner found in their own numbers.

Source: `analytics.html:673`; current classes: `section section--raised section--atmo`. Audit desktop height: 609px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 5. About the numbers.

Source: `analytics.html:696`; current classes: `section section--base section--atmo`. Audit desktop height: 631px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Preserve destinations: `the plans → pricing.html#plans`.

### 6. One platform to track, analyze and deliver

Source: `analytics.html:741`; current classes: `section section--raised section--atmo`. Audit desktop height: 501px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Preserve destinations: `Get started today → pricing.html`.

### 7. Know exactly what it's handling.

Source: `analytics.html:844`; current classes: `section section--dark final-cta`.
...
- `analytics.html:497` — Know exactly what your agent is doing — and what it's worth.
- `analytics.html:517` — Not a mockup. This is what you'll actually see.
- `analytics.html:640` — Output, not just activity.
- `analytics.html:681` — What one owner found in their own numbers.
- `analytics.html:704` — About the numbers.
- `analytics.html:750` — One platform to track, analyze and deliver
- `analytics.html:846` — Know exactly what it's handling.

## Mockup and responsive composition

Readable chart with selected date range, channel filter and definitions for sample metrics; label mock values illustrative.
...
- Proposed candidates: Editable chart and report mockup.
...
1. The mockup communicates “explain measurable performance” and the original content landmarks remain accessible.
