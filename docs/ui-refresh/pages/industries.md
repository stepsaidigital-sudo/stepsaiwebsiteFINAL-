# industries.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Help select an industry. Existing title: “Industries — StepsAI | An AI agent for every kind of business”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [industries.html](../../../industries.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`.
...
- 1 dark-marked sections; 1 legacy logo reference(s) at lines 643. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. An AI agent for every kind of business.

Source: `industries.html:487`; current classes: `vertical-hero`. Audit desktop height: 365px; padding: 72px 0px 40px.
...
### 2. Ecommerce & D2C Flagship; Healthcare & Clinics; Real Estate; Education & Training; Restaurants & Food; Fitness & Wellness; Professional Services & Legal; Beauty & Salons; Automotive; Travel & Hospitality; SaaS & Technology; Local Businesses

Source: `industries.html:501`; current classes: `section section--base section--atmo`. Audit desktop height: 4763px; padding: 0px 0px 120px.
...
Retain these content units: “Ecommerce & D2C Flagship”; “Healthcare & Clinics”; “Real Estate”; “Education & Training”; “Restaurants & Food”; “Fitness & Wellness”; “Professional Services & Legal”; “Beauty & Salons”; “Automotive”; “Travel & Hospitality”; “SaaS & Technology”; “Local Businesses”.

Preserve destinations: `Ecommerce & D2C Flagship Turn product enquiries, social interactions and abandoned carts into more purchases. See how it → industry-ecommerce.html`; `Healthcare & Clinics Respond to patient enquiries, manage appointments and automate timely reminders. See how it works → industry-healthcare.html`; `Real Estate Capture property enquiries, qualify prospects and keep every lead moving toward a site visit. See how it wor → industry-real-estate.html`; `Education & Training Manage course enquiries, automate follow-ups and connect students with the right counsellor. See ho → industry-edtech.html`; `Restaurants & Food Manage customer enquiries, promotions, orders and repeat engagement across messaging channels. Talk t → #final-cta`; `Fitness & Wellness Turn enquiries into trials, appointments and memberships with automated follow-ups. Talk to us → #final-cta`; `Professional Services & Legal Capture enquiries, qualify prospects and make consultation booking effortless. See how it  → industry-legal.html`; `Beauty & Salons Manage enquiries, appointments, reminders and customer re-engagement from one place. Talk to us → #final-cta`; `Automotive Turn vehicle enquiries into qualified leads, test drives and service appointments. Talk to us → #final-cta`; `Travel & Hospitality Respond faster to booking enquiries and keep customers informed throughout their journey. See how i → industry-hotels.html`; `SaaS & Technology Onboard users, book demos with qualified buyers, and handle 24/7 technical questions. See how it works → industry-saas.html`; `Local Businesses Bring enquiries, follow-ups and customer communication together without adding more tools. Talk to us → #final-cta`; `See the platform capabilities → agents.html`.

### 3. Whatever you sell, someone's asking a question right now.

Source: `industries.html:602`; current classes: `section section--dark final-cta`. Audit desktop height: 501px; padding: 120px 0px.
...
- `industries.html:492` — An AI agent for every kind of business.
- `industries.html:604` — Whatever you sell, someone's asking a question right now.

## Mockup and responsive composition

Consistent industry cards with use-case labels and clear routes; photography is supporting context, not the entire UI.
...
- Proposed candidates: Existing hero-ecommerce/healthcare/edtech/hotels/real-estate images.
- Stock decision: Optional replacements only after checking quality and license.
...
1. The mockup communicates “help select an industry” and the original content landmarks remain accessible.
