# case-studies.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Present verifiable customer evidence. Existing title: “Case Studies — StepsAI”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [case-studies.html](../../../case-studies.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`, `blog.css`.
...
- 2 dark-marked sections; 1 legacy logo reference(s) at lines 635. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. Real capabilities, not invented results — by industry.

Source: `case-studies.html:489`; current classes: `vertical-hero`. Audit desktop height: 512px; padding: 72px 0px 90px.
...
Source: `case-studies.html:501`; current classes: `section section--raised section--atmo`. Audit desktop height: 322px; padding: 120px 0px.
...
### 3. Four real capabilities, four industries.

Source: `case-studies.html:519`; current classes: `section section--base section--atmo`. Audit desktop height: 1181px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Retain these content units: “Ending support triage with One Inbox”; “Recovering carts on autopilot”; “Qualifying and booking, after hours”; “Reading a real analytics account”.

Preserve destinations: `E-Commerce & Support Ending support triage with One Inbox WhatsApp, Instagram and website messages, sorted and mostly an → blog-support-triage.html`; `E-Commerce & D2C Recovering carts on autopilot The exact five-node workflow that follows up on every abandoned Shopify c → blog-cart-recovery.html`; `Real Estate Qualifying and booking, after hours Budget qualified, listing matched, site visit booked — three minutes, no → blog-real-estate-agent.html`; `Cross-industry Reading a real analytics account What handled itself, what needed a human, and what the numbers actually  → blog-analytics-dashboard.html`.

### 4. From one real account, published in full.

Source: `case-studies.html:571`; current classes: `section section--dark`. Audit desktop height: 502px; padding: 120px 0px.
...
Preserve destinations: `See the full analytics dashboard &rarr; → analytics.html`.

### 5. Want to be the next real one on this page?

Source: `case-studies.html:590`; current classes: `section section--dark final-cta section--atmo`. Audit desktop height: 501px; padding: 120px 0px.
...
- `case-studies.html:493` — Real capabilities, not invented results — by industry.
- `case-studies.html:527` — Four real capabilities, four industries.
- `case-studies.html:575` — From one real account, published in full.
- `case-studies.html:596` — Want to be the next real one on this page?

## Mockup and responsive composition

Case cards with industry, problem and substantiated result; full story link and empty/filter states where present.
...
- Proposed candidates: Only approved customer logos/images.
- Stock decision: Do not use stock imagery as proof of an actual customer.
...
1. The mockup communicates “present verifiable customer evidence” and the original content landmarks remain accessible.
