# role-marketing.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Explain marketing handoff. Existing title: “Marketing &mdash; StepsAI | Campaigns that keep talking after they&#39;re sent”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [role-marketing.html](../../../role-marketing.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`.
...
- 1 dark-marked sections; 1 legacy logo reference(s) at lines 782. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. A campaign doesn&rsquo;t end when you hit send.

Source: `role-marketing.html:485`; current classes: `vertical-hero`. Audit desktop height: 593px; padding: 72px 0px 90px.
...
Source: `role-marketing.html:504`; current classes: `section section--base section--atmo`. Audit desktop height: 942px; padding: 120px 0px.
...
Preserve destinations: `Checkout → #`.

### 3. You already know these

Source: `role-marketing.html:566`; current classes: `section section--base pain-use-section section--atmo`. Audit desktop height: 2422px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Retain these content units: “Answer & convert”; “Segment & re-engage”; “Measure & report”.

### 4. What it will never do

Source: `role-marketing.html:619`; current classes: `section section--raised section--atmo`. Audit desktop height: 665px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 5. If you can only start with one thing

Source: `role-marketing.html:646`; current classes: `section section--base section--atmo`. Audit desktop height: 707px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 6. What follow-up looks like after a send

Source: `role-marketing.html:667`; current classes: `section section--raised section--atmo`. Audit desktop height: 643px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Preserve destinations: `See the platform capabilities → capabilities.html`.

### 7. About the marketing role.

Source: `role-marketing.html:703`; current classes: `section section--raised section--atmo`. Audit desktop height: 631px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 8. Your last campaign is still getting replies.

Source: `role-marketing.html:739`; current classes: `section section--dark final-cta`. Audit desktop height: 493px; padding: 120px 0px.
...
- `role-marketing.html:489` — A campaign doesn&rsquo;t end when you hit send.
- `role-marketing.html:600` — You already know these
- `role-marketing.html:627` — What it will never do
- `role-marketing.html:654` — If you can only start with one thing
- `role-marketing.html:675` — What follow-up looks like after a send
- `role-marketing.html:711` — About the marketing role.
- `role-marketing.html:743` — Your last campaign is still getting replies.

## Mockup and responsive composition

Campaign response becomes tagged lead and follow-up; retain meaningful attribution labels.
...
- Proposed candidates: Editable campaign-to-inbox flow.
...
1. The mockup communicates “explain marketing handoff” and the original content landmarks remain accessible.
