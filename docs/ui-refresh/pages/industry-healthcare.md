# industry-healthcare.html — UI implementation brief

Status: planned, not implemented. Apply after the shared shell and Sales Agent pilot.

## Objective and constraints

Explain administrative patient enquiries. Existing title: “Healthcare — StepsAI | Reduce patient-access friction”. Preserve useful content, routes and actual product claims. Read [shared system](../02-SHARED-SYSTEM.md), [asset plan](../03-ASSET-AND-MOCKUP-PLAN.md) and [implementation gates](../04-IMPLEMENTATION.md) first.

## Evidence and edit boundary

- Source: [industry-healthcare.html](../../../industry-healthcare.html). Local styles in cascade order: `styles.css`, `nav-mega-product.css`, `industries-deep.css`, `agents.css`.
...
- 1 dark-marked sections; 1 legacy logo reference(s) at lines 858. No favicon reference detected; add the shared approved favicon as part of shell work.
...
### 1. Skip the hold queue. Keep the clinical calls with your team.

Source: `industry-healthcare.html:485`; current classes: `vertical-hero`. Audit desktop height: 630px; padding: 72px 0px 90px.
...
Source: `industry-healthcare.html:503`; current classes: `section section--base section--atmo`. Audit desktop height: 942px; padding: 120px 0px.
...
### 3. Discover & book; Guide & care; Support & recall

Source: `industry-healthcare.html:564`; current classes: `section section--base pain-use-section section--atmo`. Audit desktop height: 3161px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Retain these content units: “Discover & book”; “Guide & care”; “Support & recall”.

### 4. What it will never do

Source: `industry-healthcare.html:612`; current classes: `section section--raised section--atmo`. Audit desktop height: 703px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 5. What automation looks like, live.

Source: `industry-healthcare.html:644`; current classes: `wf-section`. Audit desktop height: 1486px; padding: 112px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 6. What follow-up looks like after the visit

Source: `industry-healthcare.html:743`; current classes: `section section--raised section--atmo`. Audit desktop height: 715px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

Preserve destinations: `See the platform capabilities → capabilities.html`.

### 7. About booking with Steps AI.

Source: `industry-healthcare.html:779`; current classes: `section section--raised section--atmo`. Audit desktop height: 631px; padding: 120px 0px.

Keep the content sequence and distinctive demonstration. Use the shared reading width, type scale and spacing; remove competing decorative layers. Stack copy before its visual on mobile and keep meaningful UI text readable.

### 8. Your patients are trying to book right now.

Source: `industry-healthcare.html:815`; current classes: `section section--dark final-cta`. Audit desktop height: 493px; padding: 120px 0px.
...
- `industry-healthcare.html:488` — Skip the hold queue. Keep the clinical calls with your team.
- `industry-healthcare.html:620` — What it will never do
- `industry-healthcare.html:647` — What automation looks like, live.
- `industry-healthcare.html:751` — What follow-up looks like after the visit
- `industry-healthcare.html:787` — About booking with Steps AI.
- `industry-healthcare.html:819` — Your patients are trying to book right now.

## Mockup and responsive composition

Service question and appointment routing; avoid diagnosis claims, identifiable patient records or fabricated health outcomes.
...
- Proposed candidates: images/hero-healthcare.jpg.
- Stock decision: Optional: welcoming clinic reception without visible patient data.
...
1. The mockup communicates “explain administrative patient enquiries” and the original content landmarks remain accessible.
